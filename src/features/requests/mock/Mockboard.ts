...
export const MOCK_BOARD: BoardData = {
  ...
  icebox: [
    {
      ...
      prioridad: 'baja',
      categoria: 'Diseño',
      fechaApertura: new Date(Date.now() - 86400000 * 30).toISOString(), // hace 30 días
      fechaMaxima: null,
      progreso: 0,
    },
    {
  ...
  todo: [
    ...
    },
    {
      ...
      fechaApertura: new Date(Date.now() - 86400000 * 60).toISOString(), // hace 2 meses
      fechaMaxima: null,
      progreso: 0,
    },
  ],
  ...
  hecho: [
    {
      ...
      prioridad: 'media',
      categoria: 'Analytics',
      fechaApertura: new Date(Date.now() - 86400000 * 45).toISOString(), // hace mes y medio
      fechaMaxima: null,
      progreso: 100,
    },
    {
